...
import 'package:ontimemessaging/New%20DB/Create.dart';
...
class _SchedulePageState extends State<SchedulePage>
  ...
  ScheduleProvider _scheduleProviders = ScheduleProvider();
  TabController _tabController;
  final _messageAdd = MessageAdd();
 ...
 // Settings _settings = SettingsProvider.getDefaultSettings();
  ...
  /// loads messages.
  void _refreshMessages() => _messageAdd.loadMessages();
  ...
  //  flutterLocalNotificationsPlugin.initialize();
    ...
    _scheduleProviders.onMessageProcessed =
        (Messageclass message) => _messageAdd.updateMessage(message);
    _scheduleProviders.onNotificationTriggered = (Messageclass message) =>
        _showNotificationWithDefaultSound(
            message, flutterLocalNotificationsPlugin);

    _scheduleProviders.start(Duration(seconds: 15));
  ...
  //  Future.delayed(Duration.zero, () => _showDialogWhenFirstLoaded(context));
    return Scaffold(
      ...
      //   drawer: AppDrawer(),
      body: StreamBuilder<List<Messageclass>>(
        stream: _messageAdd.stream,
        initialData: null,
        builder: (BuildContext context, AsyncSnapshot<List<Messageclass>> snapshot) {
          final List<Messageclass> all = snapshot.data
  ...
  Future _showNotificationWithDefaultSound(
      Messageclass message, flutterLocalNotificationsPlugin) async {

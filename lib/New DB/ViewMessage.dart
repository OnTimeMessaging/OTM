...
class _ViewMessageState extends State<ViewMessage> {
  ...
  void initState() {
    ...
    // clone this object.
    _message = Messageclass.fromJson(widget.message.toJson());
  }
        ...
        GestureDetector(
          ...
          onTap: _isMessageEditable()
            ...
            Navigator.push(
              ...
              final Messageclass message = await MessageProviders.getInstance()
          ...
          child: GestureDetector(
              ...
              onTap: () async {
                await DialogProvider.showConfirmation(
                    ...
                    onYes: () async {
                      if (await MessageProviders.getInstance()

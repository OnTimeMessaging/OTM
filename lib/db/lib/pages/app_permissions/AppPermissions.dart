...
//     final List<Permission> neededPermissions = [
//
//     ];
//     final List<Permission> nonGrantedPermissions = [];
//
//     neededPermissions.forEach((p) async {
//       PermissionStatus permission =
//       await Permission().checkPermissionStatus(p);
//       if (permission != PermissionStatus.granted) nonGrantedPermissions.add(p);
//     });
//
//     final Map<PermissionGroup, PermissionStatus> requestedPermissions =
//     await PermissionHandler().requestPermissions(nonGrantedPermissions);
//     //bool status = true;

...
import 'package:ontimemessaging/db/lib/models/Message.dart';
import 'package:ontimemessaging/db/lib/providers/DateTimeFormator.dart';
import 'package:ontimemessaging/db/lib/providers/DialogProvider.dart';
import 'package:ontimemessaging/db/lib/providers/MessageProvider.dart';

import 'CreateOrEditSmsMessagePage.dart';
        ...
        body: ListView(
          children: <Widget>[
                          ...
                          child: Table(
                            ...
                            children: <TableRow>[
                              ...
                              ((_message.status == MessageStatus.FAILED) &&
                                      (_message.driver == MessageDriver.Schedule))
                                  ? TableRow(children: [
                                      Text('Reason: ',
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold)),
                                      Text(
                                          'Check your mail and allow less secure apps.')
                                    ])
                                  : TableRow(children: [
                                      Text('',
                                          style: TextStyle(
            ...
            Padding(
                ...
                child: Row(
                  children: <Widget>[
                    Icon(Icons.person, size: 35.0, color: Colors.blueGrey),
                    Flexible(
                        fit: FlexFit.tight,
                        flex: 1,
                        child: Card(

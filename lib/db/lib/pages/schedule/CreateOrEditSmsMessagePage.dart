...
import 'package:android_intent/android_intent.dart';
import 'package:ontimemessaging/db/lib/blocs/MessageBloc.dart';
...
class _CreateOrEditSmsMessagePageState
  ...
  void initState() {
    ...
    if (widget.messageMode == MessageMode.edit) {
      if (widget.message.driver == MessageDriver.Schedule) {
      } else
      ...
      body: Padding(
          ...
          child: ListView(
            children: <Widget>[
              ...
              //   ],
              // ),
              // _driverCtrl == MessageDriver.Schedule
  ...
  Message _getFinalMessage() => _driverCtrl == MessageDriver.Schedule
      ? Message(
